...
public class SeriesResponseContainer extends ResponseContainer {
     ...
     * @return The data
     */
    public SeriesDataContainer getProductsDataContainer() {
        return data;
    }
     ...
     * @param data The data
     */
    public void setSeriesDataContainer(SeriesDataContainer data) {
        this.data = data;
    }
