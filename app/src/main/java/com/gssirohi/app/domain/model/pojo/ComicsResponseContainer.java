...
public class ComicsResponseContainer extends ResponseContainer {
     ...
     * @return The data
     */
    public ComicsDataContainer getProductsDataContainer() {
        return data;
    }
     ...
     * @param data The data
     */
    public void setCharacterDataContainer(ComicsDataContainer data) {
        this.data = data;
    }
